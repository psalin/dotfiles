(custom-set-variables
 ...
 '(backup-directory-alist '(("." . "~/.emacs.d/emacssaves")))
 '(c-basic-offset 4)
 ...
 '(helm-git-grep-candidate-number-limit 3000)
 '(indent-tabs-mode nil)
 '(inhibit-startup-screen t)
 '(line-move-visual nil)
 '(list-directory-brief-switches "-aF")
 '(list-directory-verbose-switches "-alsig")
